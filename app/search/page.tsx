    ...
    const loadToggles = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('Search page toggles loaded:', data);
          setToggles(data);
        } else {
          console.error('Failed to load toggles in search page');
        }
      } catch (error) {
        console.error('Failed to load toggles in search page:', error);
      }
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.length > 0) {
          ...
          console.log('Search page stats loaded:', newStatsMap);
