...
interface SimpleDraftAuthCheckProps {
  children: React.ReactNode;
}

export default function SimpleDraftAuthCheck({ children }: SimpleDraftAuthCheckProps) {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      try {
        ...
        console.log("SimpleDraftAuthCheck result:", result);

        setIsAuthorized(result.authorized === true);
      } catch (error) {
        console.error("Draft access check error:", error);
