...
DELETE FROM daily_stats WHERE "userId" = 'nzmarie';
...
DELETE FROM daily_stats WHERE "userId" = 'nzmarie' AND date = CURRENT_DATE;
...
BEGIN
    ...
    FOR post_record IN 
        SELECT id, slug FROM posts WHERE "authorId" = 'nzmarie' AND "language" = 'en'
    LOOP
        INSERT INTO daily_stats (id, "userId", date, "pageViews", likes, "ai_questions", "ai_summaries", "language", "uniqueVisitors", reads, comments)
        VALUES (
            gen_random_uuid(),
            'nzmarie',
            CURRENT_DATE,
            CASE post_record.slug
    ...
    FOR post_record IN 
        SELECT id, slug FROM posts WHERE "authorId" = 'nzmarie' AND "language" = 'zh'
    LOOP
        INSERT INTO daily_stats (id, "userId", date, "pageViews", likes, "ai_questions", "ai_summaries", "language", "uniqueVisitors", reads, comments)
        VALUES (
            gen_random_uuid(),
