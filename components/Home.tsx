          ...
          {toggles.totalViews && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{totalStats.totalViews.toLocaleString()}</span>
              </div>
          ...
          {toggles.totalLikes && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{totalStats.totalLikes.toLocaleString()}</span>
              </div>
          ...
          {toggles.totalComments && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{totalStats.totalComments.toLocaleString()}</span>
              </div>
          ...
          {toggles.aiSummaries && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{totalStats.totalAiSummaries.toLocaleString()}</span>
              </div>
          ...
          {toggles.aiQuestions && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center border border-gray-200">
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{totalStats.totalAiQuestions.toLocaleString()}</span>
              </div>
